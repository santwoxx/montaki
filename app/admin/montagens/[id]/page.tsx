...
import {
  ...
  confirmarEnvioIntegracaoExternaAction,
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2">
        <Card>
          <p className="text-sm font-medium text-slate-500">Pagamento da loja</p>
        ...
        <Card>
          <p className="text-sm font-medium text-slate-500">Pagamento ao montador</p>
          <div className="mt-2 flex items-center justify-between">
            <Badge
              className={
      ...
      {pareceIdDeIntegracaoExterna(montagem.numeroPedido) ? (
        <Card className="mb-6 border-blue-100">
          <p className="text-sm font-medium text-slate-500">Integração externa</p>
          {montagem.notificadoCentralSyncEm ? (
            <p className="mt-2 text-sm text-emerald-700">
              ✔ Sistema externo avisado em {formatarDataHora(montagem.notificadoCentralSyncEm)}.
            </p>
            ...
            <>
              ...
              <form action={confirmarEnvioIntegracaoExternaAction.bind(null, montagem.id)}>
                <SubmitButton pendingText="Enviando…">Confirmar e avisar o sistema externo</SubmitButton>
              </form>
            </>
          ) : (
            <p className="mt-1 text-sm text-slate-500">
              Assim que a montagem for concluída (foto + assinaturas), você
              poderá confirmar o envio da conclusão de volta pro sistema
              externo aqui.
            </p>
          )}
        </Card>
