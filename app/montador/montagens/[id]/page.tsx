...
export default async function MontagemDetalheMontadorPage({
  ...
  return (
    <div>
      <p className="mb-2">
        <Link href="/montador" className="text-sm font-medium text-navy hover:text-gold transition-colors">
          ← Voltar
        </Link>
      </p>
      ...
      <div className="space-y-4">
        <Card>
          ...
          <p className="mt-1 text-slate-900">{montagem.clienteEndereco}</p>
        ...
        {montagem.clienteTelefone ? (
          <Card>
            <p className="text-sm font-medium text-slate-500">Contato do cliente</p>
            <p className="mt-1 text-slate-900">{montagem.clienteTelefone}</p>
        ...
        <Card>
          ...
          <p className="mt-1 text-slate-900">{montagem.descricaoServico}</p>
          {montagem.numeroPedido ? (
            <p className="mt-2 text-xs text-slate-400">Pedido nº {montagem.numeroPedido}</p>
          ) : null}
        ...
        {montagem.manualUrl ? (
          <Card>
            <p className="text-sm font-medium text-slate-500">Manual / instrução</p>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-navy hover:text-gold transition-colors"
            >
              📄{" "}
              {montagem.manualTipo?.startsWith("image/")
